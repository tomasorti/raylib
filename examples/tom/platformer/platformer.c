...
void DrawMainAxes(Camera2D* camera);
...
int main(void)
{
    ...
    Vector2 door = (Vector2) { 500, 300 };
    
    
    EnvItem envItems[] = {
        
        {{ 0, 0, 1000, 400 }, 0, CLITERAL(Color){ 108, 195, 255, 255 } },
        {{ 0, 400, 1000, 200 }, 1, DARKBROWN },
        {{ 300, 200, 400, 10 }, 1, ORANGE },
        {{ 250, 300, 100, 10 }, 1, PINK },
        {{ 650, 300, 100, 10 }, 1, VIOLET }
    };
    ...
    // TOM: No entiendo para que sirve el offset en este ejemplo
